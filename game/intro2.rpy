label intro2:
    ...
    "The doors in front of us slide open. Theo walks out and makes a sharp right turn, walking until he reaches a door close to the end of the hallway. There’s a slightly rusted metal 52 on the door, flush with its mahogany wood surface. Theo slaps his hand on the door and looks towards me."
    ...
    "I enter the room to a small booth, half of which is taken up by part of the device I remember spending so much of my later college years working on. A few swivel chairs are dotted along the panels and switches: they seemed to be under the assumption that it would need multiple people to run, given the machine’s size."
    ...
    "The voice is unfamiliar, and doesn’t even come from the intercom. Either way, I flinch and fall backwards in my chair with a THUMP."
